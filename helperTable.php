      ...
      <table class="table table-striped " >
        ...
        <?php while($row=mysqli_fetch_assoc($query)){?>
          <tr>
            ...
            <td>
              <a href="helper.php?edit3=<?php echo $row['helper_id'];?>" class="btn btn-outline-primary border border-primary"  value="UPDATE">UPDATE</a>
              <a href="./includes/process_inc.php?delete3=<?php echo $row['helper_id'];?>" class="btn btn-outline-danger border border-danger"  value="DELETE">DELETE</a>
            </td>
          </tr>
        <?php } ?>
      </table>
