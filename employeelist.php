                  ...
                  <div class="col-12 col-md-10 col-lg-8" id="emp-search">
                     <form class="" method="POST">
                        <div class=" row no-gutters align-items-center">
                           ...
                           <div class="col">
                              <input name="nic"
                                 class="form-control form-control-lg form-control-borderless border border-secondary"
                                 width="200px" type="search" placeholder="Enter Nic Number..">
                           </div>
                           <div class="col-auto">
                              <button class="btn btn-outline-primary border border-info" name="search"
               ...
               <div class="col-sm-4 col-md-3">
                  <form class="" action="" method="post">
                     <div class="products">
                        ...
                        <img src="./images/<?php echo $product['image']; ?>" class="xard-img-top" width="150px"
                           height="150px" alt=""><br>
                        ...
                        <div class="form-row">
                           ...
                           <div class="col">
                              <div class="md-form">
                                 <a href="profile.php?edit=<?php echo $product['employee_id'] ?>"
                                    class="btn btn-outline-warning">View Profile</a>
                              </div>
                           </div>
                           <!-- Delete Profile -->
                           <div class="col">
                              <div class="md-form">
                                 <a href="./includes/process_inc.php?delete=<?php echo $product['employee_id'] ?>"
                                    class="btn btn-outline-danger">Delete Profile</a>
                              </div>
                           </div>
                        </div><br>
                     </div>
